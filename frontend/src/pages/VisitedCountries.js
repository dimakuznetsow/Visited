  ...
  return (
    <>
      ...
      <div className="m-6">
        <div
          className={`text-lg font-medium mb-4 md:w-1/5  rounded-lg ${
            africa && africa.length === 54 ? "bg-green-500 text-white p-2" : ""
          }`}
        >
          ...
          {africa &&
            africa
              ...
              .map((country) => (
                <div
                  key={country._id}
                  className="md:w-1/4 mx-2 md:mx-4 my-2 border border-sky-500 rounded-lg py-2"
                >
      ...
      <div className="m-6">
        ...
        >
          Australia & Oceania: {australiaOceania && australiaOceania.length}/15{" "}
          {australiaOceania &&
      ...
      <div className="m-6">
        <div
          className={`text-lg font-medium mb-4 md:w-1/5  rounded-lg ${
            europe && europe.length === 45 ? "bg-green-500 text-white p-2" : ""
          }`}
        >
